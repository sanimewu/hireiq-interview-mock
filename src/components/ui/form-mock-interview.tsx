...
import CustomBreadCrumb from "@/components/ui/custom-bread-crumb.tsx";
...
export const FormMockInterview = ({ initialData }: FormMockInterview) => {
    ...
    `;
        ...
        // console.log(responseText.response.text().trim());
        const cleanedResponse = cleanJsonResponse(responseText.response.text());
    ...
    return (
        <div className="w-full flex-col space-y-4">
            ...
            <div className="mt-4 flex items-center justify-between w-full">
                <Heading title={title} isSubHeading={true} />
